...
<section class="container">
    <div class="card">
        <h1>Blog & Haberler</h1>
        <p>İpuçları, stratejiler ve yeni açık artırma duyuruları.</p>
        <div class="grid">
            <div class="card">
                <h3>Teklif stratejileri</h3>
                <p>Başarılı bir açık artırma için 5 öneri.</p>
                <p><strong>Fotoğraf:</strong> Retro koleksiyon görselleri</p>
            </div>
            <div class="card">
                <h3>Satıcı rehberi</h3>
                <p>Lot oluşturma ve listeleme adımları.</p>
                <p><strong>Fotoğraf:</strong> Mağaza vitrin sahnesi</p>
            </div>
            <div class="card">
                <h3>Güvenli ödeme</h3>
                <p>Escrow sistemi nasıl çalışır?</p>
                <p><strong>Fotoğraf:</strong> Ödeme güvenlik illüstrasyonu</p>
            </div>
        </div>
    </div>
</section>
...
<footer>
    Artirup © 2050 • Blog güncellemeleri.
</footer>
</body>
</html>
